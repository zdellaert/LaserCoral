...
#SBATCH -t 48:00:00
#SBATCH --mail-type=BEGIN,END,FAIL,TIME_LIMIT_80 #email you when job starts, stops and/or fails #email you when job starts, stops and/or fails
...
nextflow run nf-core/methylseq \
  ...
  --outdir /scratch3/workspace/zdellaert_uri_edu-shared/methylseq_bwa_fb \
  --aligner bwameth \
  --methyl_kit \
  --igenomes_ignore \
