...
cluster_GOs <- Oral_enriched_clustered %>% dplyr::filter(GO.cluster == 11|
                                                           GO.cluster == 13|
...
### Plotting of each tissue cluster separately
...
ggsave("../output_RNA/differential_expression/composite_figs/Figure3.png", final_fig, width = 12, height = 16, dpi = 300)
```
