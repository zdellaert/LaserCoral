...
# Specify colors
ann_colors = list(
    Tissue = c(Oral = "palegreen3" ,Aboral = "mediumpurple1")
)
```
...
VST_all <- vsd_long %>% ggplot(aes(x = Tissue,y = tissue_vst_mean, fill = Tissue)) + geom_boxplot() + theme_minimal() +  
  labs(x = "Tissue", y = "VST Expression", 
       title = "VST expression of all expressed genes by tissue type") 

save_ggplot(VST_all, "../output_WGBS/figures/1_VST_all_boxplot")
```
...
save_ggplot(vst_percmeth, "../output_WGBS/figures/2_VST_tissue_percentmeth")
