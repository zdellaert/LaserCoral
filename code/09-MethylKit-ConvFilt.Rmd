...
dml_df <- getData(DMLStats_Tissue)
...
volcano_plain <- EnhancedVolcano(dml_df, 
    lab = NA,
    x = 'meth.diff',
    y = 'qvalue',
    ...
    pointSize = 1,
    labSize = 2,boxedLabels = TRUE,max.overlaps = 60) + annotate("text", x = 50, y = 20, label = paste0("Total = ", nrow(dml_df), " CpGs"), hjust = 0)

save_ggplot(volcano_plain, "../output_WGBS/figures/7_DML_volcano_enhanced")
```
