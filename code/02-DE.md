...
- [0.11 Expression of certain gene lists of interest - ones featured in
  ...
  - [0.11.7 Aboral Oral Larvae Paper - Pdam
    genome](#0117-aboral-oral-larvae-paper---pdam-genome)
...
```
    ...
    ## [22] blob_1.2.4               DelayedArray_0.36.0      BiocParallel_1.44.0     
    ## [25] irlba_2.3.5.1            parallel_4.5.2           R6_2.6.1                
    ## [28] stringi_1.8.7            SQUAREM_2021.1           limma_3.66.0            
    ## [31] numDeriv_2016.8-1.1      Rcpp_1.1.0               knitr_1.50              
    ## [34] timechange_0.3.0         Matrix_1.7-4             splines_4.5.2           
    ## [37] tidyselect_1.2.1         rstudioapi_0.17.1        dichromat_2.0-0.1       
    ## [40] abind_1.4-8              yaml_2.3.10              codetools_0.2-20        
    ## [43] affy_1.88.0              curl_7.0.0               lattice_0.22-7          
    ## [46] plyr_1.8.9               withr_3.0.2              KEGGREST_1.50.0         
    ## [49] S7_0.2.0                 coda_0.19-4.1            evaluate_1.0.5          
    ## [52] survival_3.8-3           Biostrings_2.78.0        pillar_1.11.1           
    ## [55] affyio_1.80.0            BiocManager_1.30.26      renv_1.1.5              
    ## [58] invgamma_1.2             RCurl_1.98-1.17          truncnorm_1.0-9         
    ## [61] emdbook_1.3.14           hms_1.1.4                scales_1.4.0            
    ## [64] xtable_1.8-4             glue_1.8.0               tools_4.5.2             
    ## [67] BiocIO_1.20.0            GenomicAlignments_1.46.0 annotate_1.88.0         
    ## [70] locfit_1.5-9.12          mvtnorm_1.3-3            XML_3.99-0.19           
    ## [73] grid_4.5.2               bbmle_1.0.25.1           bdsmatrix_1.3-7         
    ## [76] colorspace_2.1-2         AnnotationDbi_1.72.0     restfulr_0.0.16         
    ## [79] cli_3.6.5                mixsqp_0.3-54            S4Arrays_1.10.0         
    ## [82] gtable_0.3.6             digest_0.6.37            SparseArray_1.10.1      
    ## [85] rjson_0.2.23             farver_2.1.2             memoise_2.0.1           
    ## [88] htmltools_0.5.8.1        lifecycle_1.0.4          httr_1.4.7              
    ## [91] GlobalOptions_0.1.2      statmod_1.5.1            bit64_4.6.0-1           
    ## [94] MASS_7.3-65
...
``` r
Biomin_broc_original <- read.csv("../output_RNA/marker_genes/Pacuta_Biomin_Spis_ortholog.csv") %>% dplyr::rename("query" = Pacuta_gene) #%>% select(-c(X,accessionnumber_gene_id, ref))
...
### 0.11.7 Aboral Oral Larvae Paper - Pdam genome

Ramon-Mateu J, Ferraioli A, Teixidó N, Domart-Coulon I, Houliston E,
Copley RR. 2025 Aboral cell types of Clytia and coral larvae have shared
features and link taurine to the regulation of settlement. Science
Advances 11, eadv1159. (<doi:10.1126/sciadv.adv1159>)
