...
# Function to visualize a pathway
visualize_pathway <- function(pathway_id, suffix, gene_data) {
  pathview(
    gene.data = gene_data,
...
for (pathway in pathways) {
  visualize_pathway(pathway, "DE_05", gene.data)
  visualize_pathway(pathway, "allgenes", gene.data_allgenes)
}
```
