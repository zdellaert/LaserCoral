...
```
With a sequencing coverage of 55X, and a within-group cv of 0.8215862, and sample size of 5, we will be able to detect an effect size of 4.372025 at a power of 0.8.
...
rnapower(depth=290, cv=0.8215862 , n = 5, alpha= .05, effect=c(1.25, 1.5, 1.75, 2,5, 6))
```
