...
```{bash, eval=FALSE}
cd ../output_WGBS/methylseq_V3_bwa_test/methyldackel/min_efficiency_test
...
for (sample in samples) {
  output_dir <- paste0("/project/pi_hputnam_uri_edu/zdellaert/LaserCoral/output_WGBS/methylseq_V3_bwa_test/methyldackel/min_efficiency_test/min_50_", sample, "_quant")
...
write.csv(all_methylation_data, "../output_WGBS/methylseq_V3_bwa_test/methyldackel/min_efficiency_test/min_50_gene_body_methylation.csv",row.names = FALSE)
write.csv(conversion_eff_data, "../output_WGBS/methylseq_V3_bwa_test/methyldackel/min_efficiency_test/min_50_conversion_efficiency.csv",row.names = FALSE)
```

Analyze and plot:

```{r}
conversion_eff_data <- read.csv( "../output_WGBS/methylseq_V3_bwa_test/methyldackel/min_efficiency_test/min_50_conversion_efficiency.csv", sep = ",", header = TRUE) 
all_methylation_data <- read.csv(  "../output_WGBS/methylseq_V3_bwa_test/methyldackel/min_efficiency_test/min_50_gene_body_methylation.csv", sep = ",", header = TRUE) 
...
wc -l min_90_LCM_3_quant/*_total.txt > min_90_total_counts.txt

for dir in min_90_*_quant; do
  wc -l ${dir}/*_unmethylated.txt > ${dir}/${dir}_counts.txt
done
```
